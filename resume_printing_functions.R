# This file contains all the code needed to parse and print various sections of resume
...
\n\n\n"
  ...
  section_data <- dplyr::filter(cv$entries_data, in_resume == TRUE, section == section_id)
